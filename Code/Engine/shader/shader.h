...
#define TEXTURE0					"u_texture0"
#define TEXTURE1					"u_texture1"
#define TEXTURE2					"u_texture2"
#define TEXTURE3					"u_texture3"
#define TEXTURE4					"u_texture4"
...
#define LIGHTMVPMARTRIX				"u_lightMVPMatrtix"
